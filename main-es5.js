...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAsideControllerAsideControllerComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppStopAtStopAtComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _aside_controller_aside_controller_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./aside-controller/aside-controller.component */
    ...
    var _column_column_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var _stop_at_stop_at_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./stop-at/stop-at.component */
    "./src/app/stop-at/stop-at.component.ts");
    /* harmony import */


    var _pipes_card_title_pipe__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./pipes/card-title.pipe */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _aside_controller_aside_controller_component__WEBPACK_IMPORTED_MODULE_4__["AsideControllerComponent"], _board_board_component__WEBPACK_IMPORTED_MODULE_5__["BoardComponent"], _column_column_component__WEBPACK_IMPORTED_MODULE_7__["ColumnComponent"], _card_card_component__WEBPACK_IMPORTED_MODULE_8__["CardComponent"], _stop_at_stop_at_component__WEBPACK_IMPORTED_MODULE_9__["StopAtComponent"], _pipes_card_title_pipe__WEBPACK_IMPORTED_MODULE_10__["CardTitlePipe"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"]],
      providers: [],
  ...
  /***/
  function srcAppAsideControllerAsideControllerComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAsideControllerAsideControllerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AsideControllerComponent", function () {
      return AsideControllerComponent;
    });
    /* harmony import */
    ...
    var AsideControllerComponent =
    /*#__PURE__*/
    function () {
      function AsideControllerComponent() {
        _classCallCheck(this, AsideControllerComponent);
      }

      _createClass(AsideControllerComponent, [{
        key: "ngOnInit",
    ...
    AsideControllerComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-aside-controller',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./aside-controller.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/aside-controller/aside-controller.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./aside-controller.component.scss */
      "./src/app/aside-controller/aside-controller.component.scss")).default]
  ...
  function srcAppBoardBoardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_column_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../services/column-service.service */
    "./src/app/services/column-service.service.ts");
    /* harmony import */


    var _services_card_service_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function BoardComponent(columnService, cardService) {
      ...
      _createClass(BoardComponent, [{
        key: "cardTransfer",
        value: function cardTransfer(card) {
          console.log(card);
        }
      }, {
        key: "ngOnInit",
        ...
        key: "handleCardDrop",
        value: function handleCardDrop($event, id) {
          var _this = this;
          ...
          if (col.stopAt === undefined || col.stopAt > col.cards.length) {
            ...
            if (this.operableCard !== undefined && !col.cards.includes(this.operableCard)) {
              var prevCol = this.columns.find(function (col) {
                return col._id === _this.operableCol;
              });
              this.operableCard.timestamp = new Date();

              if (this.columns.findIndex(function (col) {
                return prevCol._id === col._id;
              }) === this.columns.length - 2) {
                this.operableCard.isCompleted = true; // @ts-ignore

                col.cards.unshift(this.operableCard);
              } else {
                this.operableCard.isCompleted = false; // @ts-ignore

                col.cards.push(this.operableCard);
              } // @ts-ignore


              prevCol.cards = prevCol.cards.filter(function (card) {
                return card._id !== _this.operableCard._id;
              });
            ...
            this.columns.find(function (col) {
              return col._id === id;
            }).cards.push( // @ts-ignore
            this.cardService.addNewCard());
          }
        }
      }, {
        key: "changeStopAt",
        value: function changeStopAt() {
          this.isStopAtInputVisible = false;
        }
      }, {
        key: "setStop",
        value: function setStop(id, $event) {
          if ($event !== undefined) {
            if ($event.key !== 'Enter') {
              return;
            }
        ...
        key: "showChangeForm",
        value: function showChangeForm() {
          this.isShowChangeForm = true;
        }
      }, {
        key: "setColumnName",
        value: function setColumnName(id, $event) {
        ...
        key: "startCardTransition",
        value: function startCardTransition($event, card) {
          // @ts-ignore
          $event.dataTransfer.setData('text', $event.currentTarget.innerText);
          this.operableCard = card;
        }
      }, {
        key: "startCardLeaveTransition",
        value: function startCardLeaveTransition($event, colId, cardId) {
        ...
        key: "showCardForm",
        value: function showCardForm() {
          this.isCardTitleFormVisible = true;
        }
      }, {
        key: "setCardName",
        value: function setCardName(colId, cardId, $event) {
          if ($event.key === 'Enter' || $event === undefined) {
            var col = this.columns.find(function (c) {
              return c._id === colId;
            }); // @ts-ignore

            var card = col.cards.find(function (c) {
              return c._id === cardId;
            });
  ...
  function srcAppCardCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(CardComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.color = "".concat(this.card.color, " solid 0.15rem");
        }
      }, {
        key: "showTitleForm",
        value: function showTitleForm() {
          this.isTitleFormShowed = true;
        }
      }, {
        key: "submitNewCardName",
        value: function submitNewCardName($event) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], CardComponent.prototype, "card", void 0);
  ...
  /***/
  function srcAppColumnColumnComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppColumnColumnComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _services_card_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../services/card-service.service */
    "./src/app/services/card-service.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function ColumnComponent(cardService) {
      ...
      _createClass(ColumnComponent, [{
        ...
        key: "onChanged",
        value: function onChanged(stopAt) {
        ...
        key: "transferCard",
        value: function transferCard(card) {
          this.cardTransfer.emit(card);
        }
      }, {
        key: "handleCardDrop",
        value: function handleCardDrop($event, id) {
          var drop = $event.dataTransfer.getData('text');

          try {
            var card = JSON.parse(drop);
        ...
        key: "submitNewColumnName",
        value: function submitNewColumnName($event) {
        ...
        key: "startCardDrag",
        value: function startCardDrag($event, card, id) {
        ...
        key: "addAlreadyExistCard",
        value: function addAlreadyExistCard(_ref) {
          var card = _ref.card;

          if (this.column.cards.find(function (c) {
        ...
        value: function removeCard() {
          ...
          if (this.cardTransfered) {
            this.column.cards = this.column.cards.filter(function (c) {
              return c._id !== _this2.cardTransfered._id;
            });
          }
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ColumnComponent.prototype, "column", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], ColumnComponent.prototype, "cardTransfer", void 0);
    ColumnComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-column',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      ...
      "./src/app/column/column.component.scss")).default]
    })], ColumnComponent);
    /***/
  },
  ...
  /***/
  function srcAppPipesCardTitlePipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CardTitlePipe", function () {
      return CardTitlePipe;
    });
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function CardTitlePipe() {
        _classCallCheck(this, CardTitlePipe);
      }

      _createClass(CardTitlePipe, [{
        key: "transform",
        value: function transform(card) {
          if (card.title.length > MAX_TITLE_LENGTH) {
            return "".concat(card.title.substr(0, MAX_TITLE_LENGTH), "...");
          }
    ...
    CardTitlePipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
      name: 'cardTitle'
    })], CardTitlePipe);
    /***/
  },
  ...
  /***/
  function srcAppServicesCardServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _column_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    function () {
      ...
      _createClass(CardServiceService, [{
        key: "addNewCard",
        value: function addNewCard() {
          return {
            title: 'New Card',
    ...
    CardServiceService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], CardServiceService);
    /***/
  },
  ...
  /***/
  function srcAppServicesColumnServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ColumnServiceService", function () {
      return ColumnServiceService;
    });
    /* harmony import */
    ...
    var ColumnServiceService =
    /*#__PURE__*/
    function () {
      function ColumnServiceService() {
        _classCallCheck(this, ColumnServiceService);
      }

      _createClass(ColumnServiceService, [{
        key: "createNewColumn",
        value: function createNewColumn() {
          return {
            title: 'New Column',
            _id: generateId(),
            cards: [],
    ...
    ColumnServiceService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
  ...
  /***/
  function srcAppStopAtStopAtComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppStopAtStopAtComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StopAtComponent", function () {
      return StopAtComponent;
    });
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function StopAtComponent() {
        _classCallCheck(this, StopAtComponent);
      ...
      _createClass(StopAtComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "change",
        value: function change(stopAt) {
          if (typeof stopAt === 'number') {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], StopAtComponent.prototype, "stop", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], StopAtComponent.prototype, "length", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], StopAtComponent.prototype, "onChanged", void 0);
    StopAtComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-stop-at',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./stop-at.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/stop-at/stop-at.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./stop-at.component.scss */
      "./src/app/stop-at/stop-at.component.scss")).default]
    })], StopAtComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Asus\Desktop\пг\Angular\New projects\canb\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
